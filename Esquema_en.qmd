...
::: {layout-ncol="2"}
![CT dummies image](img/dummies.jpg){width="10%"}

![Dummies image](img/Dummies_bebig.png){width="10%"}
:::

## Dummies MRI

::: {layout-ncol="2"}
![MRI dummies image](img/DummiesMR_Image.jpg){width="10%"}

![dummies image](img/DummiesMR.jpg){width="10%"}
:::
